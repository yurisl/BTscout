...
> ⚠️ Cores citadas neste documento (ex: `#1565C0`, `#C62828`) são de versão anterior à identidade "Areia & Oceano". Paleta oficial: [[../12-Design-System/01-Colors|12-Design-System/01-Colors]] — Dupla A Azul Oceano `#1E88E5`, Dupla B Laranja Dupla B `#FB8500` (nunca vermelho).
