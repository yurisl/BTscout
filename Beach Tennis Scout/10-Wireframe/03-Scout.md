...
>
> ⚠️ **Nota de layout (2026-07-14):** o **header do topo foi removido**. Início/tipo de partida/Estatísticas/Pausar/Desfazer agora vivem em um **rodapé fixo** na base da tela. O **placar deixou de ser um card grande centralizado** e passou a um placar compacto estilo transmissão esportiva, ancorado no **canto superior esquerdo**, ocupando aproximadamente a altura que o header antigo ocupava. O espaço central da tela — antes dividido entre placar e botões — agora é **inteiramente dos botões de ação** (Passo 1 e Passo 2 do registro), que passam a ser o conteúdo dominante da tela. Ver [[../12-Design-System/03-Components|12-Design-System/03-Components]] § "Rodapé de navegação" e § "Placar / Scoreboard — variante compact". Os mockups ASCII abaixo (com header no topo e placar central) refletem a estrutura **anterior** a essa mudança.
